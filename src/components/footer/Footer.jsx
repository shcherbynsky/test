            ...
            <div className="footer__wrapper">
                <div className="footer__container">
                    <div className="footer__about about-footer">
                        <a href='#!' className="about-footer__logo logo">
                    ...
                    <div className="footer__links links-footer">
                        <div className="links-footer__body">
                            <div className="links-footer__column">
                                <h6 className="links-footer__title">Categhory</h6>
                                <ul className="links-footer__list">
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 1</a>
                                    </li>
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 3</a>
                                    </li>
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 4</a>
                                    </li>
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 5</a>
                                    </li>
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 6</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="links-footer__column">
                                <h6 className="links-footer__title">Play better</h6>
                                <ul className="links-footer__list">
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 1</a>
                                    </li>
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 2</a>
                                    </li>
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">item 3</a>
                                    </li>
                            ...
                            <div className="links-footer__column">
                                <h6 className="links-footer__title">Useful links</h6>
                                <ul className="links-footer__list">
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">link</a>
                                    </li>
                                    <li className="links-footer__item">
                                        <a href="#!" className="links-footer__link">link</a>
                                    </li>
                        ...
                        <div className="copyright">Copyright © 2024. Tous droits réservés.</div>
                    </div>
                </div>
            </div>
        </footer>
